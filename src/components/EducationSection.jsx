import ViewMoreButton from "./buttons/ViewMoreButton";"./buttons/ViewMoreButton"
      ...
      <ul className="education-items">
        <li className="education-item">
          ...
          <div className="education-item-right">
            <ViewMoreButton url="https://www.cpp.edu/index.shtml"/>
          </div>
        </li>
        <li className="education-item">
          <div className="education-item-left">
      ...
      <ul className="education-items">
        <li className="education-item">
          <div className="education-item-left">
            ...
            <p>
              GDSC is a project oriented club intended to bridge the gap between
